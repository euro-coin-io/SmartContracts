...
/**
 * @title Equity
 * @notice If the dEURO system was a bank, this contract would represent the equity on its balance sheet.
...
contract Equity is ERC20PermitLight, MathUtil, IReserve {
    ...
    constructor(dEURO dEURO_) ERC20(18) {
        dEURO = dEURO_;
    }

    function name() external pure override returns (string memory) {
        return "native dEURO Protocol Share";
    }
    ...
    /**
     * @notice Calculate shares received when investing dEUROs
     ...
     * dEURO system except for a group of small nDEPS holders who still believes in it and is willing to provide
