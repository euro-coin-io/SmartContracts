...
contract Position is Ownable, IPosition, MathUtil {
    ...
    /**
     * @notice The dEURO contract.
     */
    IdEURO public immutable dEURO;
    ...
    /**
     * @notice The interest in parts per million per year that is deducted when minting dEUROs.
     * To be paid upfront.
     */
    ...
    /**
     * @notice Adjust this position's limit to allow a clone to mint its own dEUROs.
    ...
    function repay(uint256 amount) public {
        ...
        uint256 actuallyRepaid = IdEURO(dEURO).burnWithReserve(amount, reserveContribution);
