 ...
 */
contract dEURO is ERC20PermitLight, IdEURO {
    /**
    ...
    /**
     * @notice Initiates the dEURO with the provided minimum application period for new plugins
    ...
    /**
     * @notice Publicly accessible method to suggest a new way of minting dEURO.
     ...
     * adds value to the dEURO system. Complex proposals should have application periods and applications fees
     ...
     * the proposed minter.
     *
     * @param _minter              An address that is given the permission to mint dEUROs
    ...
    /**
     * @notice Allows minters to register collateralized debt positions, thereby giving them the ability to mint dEUROs.
    ...
    /**
     * @notice The amount of equity of the dEURO system in dEURO, owned by the holders of native dEURO Protocol Shares.
    ...
    /**
     * @notice Notify the dEURO that a minter lost economic access to some coins. This does not mean that the coins are
